...
import math
from reporting.step_projection import steps_to_tabs_boxes as _steps_to_tabs_boxes
...
def steps_to_tabs_boxes(module_title: str, steps: list, default_tab: str):
    """Compatibility wrapper around the pure report projection owner."""

    return _steps_to_tabs_boxes(module_title, steps, default_tab)
