...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        in pre_scoring_body,
        "solver_preserves_continue": 'if no_real_change_state["should_continue"]:' in pre_scoring_body
        and "continue" in pre_scoring_body,
        "solver_rehydrates_no_real_change_fields": 'rejected_as_no_real_change = no_real_change_state["rejected_as_no_real_change"]'
        in pre_scoring_body
        and 'shear_remove_links_candidate_dropped_reason = no_real_change_state[' in pre_scoring_body,
