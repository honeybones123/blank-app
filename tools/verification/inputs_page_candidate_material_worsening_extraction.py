...
def main() -> int:
        ...
        call_record.update(
            {
                ...
                "bound_failed_labels": getattr(extracted, "_failed_check_labels", None)
                is bridge._failed_check_labels,
                "bound_util_gap": getattr(extracted, "utilisation_gap", None) is bridge.utilisation_gap,
    ...
    checks["bridge_runtime_binds_module_globals"] = (
        getattr(extracted, "_agent_debug_log", None) is bridge._agent_debug_log
        and getattr(extracted, "_failed_check_labels", None) is bridge._failed_check_labels
        and getattr(extracted, "utilisation_gap", None) is bridge.utilisation_gap
