...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_delegates_initial_eval_state": "_prepare_one_click_solver_initial_eval_state_coordinator(" in runtime_setup_body,
        "solver_preserves_failed_eval_return": "_build_evaluate_failed_solver_return_coordinator(" in runtime_setup_body,
        "solver_rehydrates_initial_eval_state_fields": 'init_eval = solver_initial_eval_state["init_eval"]' in runtime_setup_body
        and 'target_band_domain = solver_initial_eval_state["target_band_domain"]' in runtime_setup_body
        and 'init_progress = solver_initial_eval_state["init_progress"]' in runtime_setup_body,
