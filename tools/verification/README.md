...
| --- | --- | --- |
| `canonical_verification_runner.py` | Single release verification and cleanup-certification entry point. It runs verifier self-checks, taxonomy/retirement checks, and the manifest-driven release gates. | `python tools/verification/canonical_verification_runner.py --execute` |
