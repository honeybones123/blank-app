...
def build_payload() -> dict[str, Any]:
    ...
    result_helper_start, result_helper_end, result_helper = _function_segment(
        source,
        "_build_one_click_solver_candidate_shear_truth_preview_gate_result_state_coordinator",
    )
    ...
    return {
        ...
        "result_helper_segment": {
            "function": "_build_one_click_solver_candidate_shear_truth_preview_gate_result_state_coordinator",
