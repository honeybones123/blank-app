...
CHECKPOINTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "function_or_symbol": "resolve_final_visible_design_guide_item",
        "required_tokens": [
            "def resolve_final_visible_design_guide_item(",
            "Final Design Guide publication resolver.",
            "active_failures",
        ],
        ...
        "can_restamp_debug_session": True,
        "downstream_of_publication_object": False,
        "expected_future_owner": "Future Design Brain final-publication orchestrator; page remains adapter",
    },
    {
        "order": 8,
    ...
    {
        "order": 14,
        "checkpoint": "Late render-after-publication override paths",
        "owner_module_file": "inputs_page.py",
        "function_or_symbol": "post-click / low-util override helpers",
        "required_tokens": [
        ...
        "authority_type": "B/F. late page override authority",
        "can_change_outcome": True,
        "can_change_cta": True,
        "can_change_blocker_reason": True,
        "can_change_visible_wording": True,
