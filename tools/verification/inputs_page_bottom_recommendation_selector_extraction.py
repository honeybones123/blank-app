...
def main() -> int:
    ...
    checks: dict[str, bool] = {
        ...
        "bridge_binds_dependencies": "runtime=_build_bottom_selector_runtime()" in bridge_body,
        ...
        "module_has_dependency_binder": (
            "class BottomRecommendationSelectorRuntime" in module_source
        ...
        call_record.update(
            {
                ...
                "bound_selector": runtime.select_best_candidate is bridge._select_best_auto_design_candidate,
                "bound_trace": runtime.merge_rank_trace is bridge._merge_design_guide_rank_trace,
                "bound_strict": runtime.strictly_rejectable_band_winner is bridge._is_strictly_rejectable_band_winner,
            }
        )
    ...
    checks["bridge_runtime_binds_module_globals"] = all(
        call_record.get(key) is True
        for key in ("bound_selector", "bound_trace", "bound_strict")
    )
