...
boundary, preserves branch order, and produces stable plain-data results.
Composed locks may depend on this contract, so this verifier must not read
those locks back as a prerequisite.
"""
