...
def main() -> int:
    ...
    fresh_overview_handoff_tokens = {
        "fresh_collect_before_debug_fallback": (
            "_fresh_dg_overview = _collect_design_overview(" in inputs_source
            and "_debug_dg_overview = guidance_debug.get(\"overview\")" in inputs_source
        ),
        "fresh_overview_used_when_statuses_present": (
            "_dg_overview = dict(_fresh_dg_overview)" in inputs_source
        ),
        "freshness_debug_stamp": (
            "design_guide_overview_refreshed_from_current_state" in inputs_source
        ),
    }
