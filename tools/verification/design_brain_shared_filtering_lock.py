...
FOCUSED_VERIFIERS = (
    ...
    "bottom_reo_recommendation_readiness_snapshot_9N",
)
...
def main() -> int:
    ...
    selector_segment = _function_segment(inputs_source, "_compute_bottom_reo_recommendation")
    bottom_reo_segment = selector_segment
    ...
    checks = {
        ...
        "auto_design_selector_delegates_row_layout_filter": "_candidate_materially_improves(" in selector_segment,
        "auto_design_selector_has_no_inline_row_layout_formula": "is_valid_reo_layout(" not in selector_segment,
        "bottom_reo_delegates_prerank_filter_policy": "_bottom_recommendation_prefilter_ok(" in bottom_reo_segment,
        "bottom_reo_delegates_growth_filter_policy": "_candidate_is_growth_move(" in bottom_reo_segment,
        "bottom_reo_has_evaluated_filter_boundary_trace": "_emit_bottom_reo_filter_boundary_trace(" in bottom_reo_segment,
        "bottom_reo_result_packaging_is_family_helper": '"updates": dict(best.get("updates") or {})' in bottom_reo_segment,
    }
