...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        in iteration_gate_after_current_eval_body
        and 'tightening_meta = in_band_cleanup_pool_state["tightening_meta"]' in iteration_gate_after_current_eval_body
        and 'if in_band_cleanup_pool_state["should_stop_current_reached_target_band"]:' in iteration_gate_after_current_eval_body,
