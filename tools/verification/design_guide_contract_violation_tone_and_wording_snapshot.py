...
def _stale_contract_violation_row() -> dict[str, Any]:
    ...
    checks = {
        ...
        "render_view_model_uses_publication_detector": "is_final_design_guide_family_contract_violation_item(item_d)" in final_source,
        "dashboard_status_uses_publication_detector": "family_contract_violation = is_final_design_guide_family_contract_violation_item(item_d)" in final_source,
        "dashboard_status_accepts_error_bucket": 'if family_contract_violation:' in final_source,
        "legacy_guidance_label_uses_publication_detector": (
            "family_contract_violation = is_final_design_guide_family_contract_violation_item(item_d)" in final_source
            and '"badge": "ERROR"' in final_source
        ),
        "legacy_guidance_renderer_forces_error_bucket": (
            "if family_contract_violation:" in final_source
            and '"bucket": "error"' in final_source
        ),
        ...
        "normaliser_exported_from_publication": '"normalise_stale_family_contract_violation_item"' in final_source,
        "view_model_calls_normaliser_before_detector": (
            "item_d = normalise_stale_family_contract_violation_item(item, debug)" in final_source
            and "family_contract_violation = is_final_design_guide_family_contract_violation_item(item_d)" in final_source
        ),
        "render_model_calls_normaliser": (
            "item_d = normalise_stale_family_contract_violation_item(item, debug)" in final_source
            and "final_card_model_fields" in final_source
        ),
