...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "candidate_pipeline_rehydrates_prepared_loop_fields": (
            ...
            in after_collection_body
            and '"pool_labels": candidate_pipeline_scope["pool_labels"]' in source
            and '"mixed_direction_mode": candidate_pipeline_scope["mixed_direction_mode"]'
            in source
            and '"rejected_as_evaluation_failed": candidate_pipeline_scope[' in source
        ),
