...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "aggregate_delegates_apply_selected_candidate": (
            "_handle_one_click_solver_accepted_candidate_apply_flow_coordinator(" in aggregate
            and "_handle_one_click_solver_apply_selected_candidate_and_evaluate_coordinator(" in apply_flow
        ),
