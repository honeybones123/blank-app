...
def _module_cases() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            and scenarios["actionable_resolved"]["source_candidate_id"] == "cand-1",
...
def main() -> int:
    ...
    checks = {
        ...
        "module_keeps_contract_body": "resolve_item_updates(work" in module_body
        and "check_executor(" in module_body,
