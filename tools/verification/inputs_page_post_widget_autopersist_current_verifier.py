...
def main() -> int:
    ...
    summary_pipeline_source, _ = _function_source(route_source, "render_inputs_summary_pipeline_current_coordinator")
    ...
    summary_pipeline_call_index = render_inputs_source.find("render_inputs_summary_pipeline_current_coordinator(")
    ...
    if not (0 <= widget_call_index < summary_pipeline_call_index):
        failures.append(
