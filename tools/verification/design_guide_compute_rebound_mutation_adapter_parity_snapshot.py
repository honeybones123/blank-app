...
def _capture() -> dict[str, Any]:
    ...
    return {
        ...
        "source_checks": {
            ...
            "late_live_mutation_still_present": (
                "primary_item_for_evidence.update(_late_rebound_item)" in inputs_source
                or "primary_item_for_evidence.update(_late_mutation_item)" in inputs_source
            ),
            "post_live_mutation_still_present": (
                "collapsed_guidance_items[0] = dict(_post_evidence_rebound)" in inputs_source
                or "_post_mutation_collapsed_items = list(" in inputs_source
            ),
