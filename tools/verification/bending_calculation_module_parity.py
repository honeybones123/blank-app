...
def test_bending_page_wrapper_delegates_to_core_state_adapter() -> None:
    ...
    page_source = (ROOT / "bending_page_runtime.py").read_text(encoding="utf-8")
...
def test_bending_capacity_from_state_values_contract() -> None:
    ...
    try:
        bending_checks_helpers.get_param = (
            lambda name, default=None: 99.0 if name == "lig_d" else default
        )
