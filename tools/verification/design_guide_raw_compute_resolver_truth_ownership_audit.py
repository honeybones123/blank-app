...
def _source_token_checks(source: str) -> dict[str, bool]:
    return {
        "compute_resolver_call_present": "final_compute_resolution = resolve_final_visible_design_guide_item(" in source,
        "compute_resolver_publication_adapter_present": "final_compute_item = _collapsed_guidance_item_from_final_publication_authority(" in source,
        "late_rebound_call_present": "_late_rebound_item = _publish_final_visible_design_guide_contract_binding(" in source,
        "late_rebound_publication_adapter_present": "_late_rebound_item = _collapsed_guidance_item_from_final_publication_authority(" in source,
        "post_core_rebound_call_present": "_post_evidence_rebound = _publish_final_visible_design_guide_contract_binding(" in source,
        "post_core_rebound_publication_adapter_present": "_post_evidence_rebound = _collapsed_guidance_item_from_final_publication_authority(" in source,
    }
