...
def _current_live_evidence() -> dict[str, Any]:
    ...
    extracted_source = "\n".join(
        ...
        for path in (
            ...
            "design_brain/family_ladder_dispatch.py",
    ...
    anchors = {
        ...
        "family_first_live_cutover": (
            "build_bending_overdesign_live_evaluator" in extracted_source
            and "BENDING_OVERDESIGN_GOVERNS" in extracted_source
            and "family_ladder:" in extracted_source
        ),
    }
    observed_surfaces = []
...
def main() -> int:
    ...
    checks = {
        ...
        "family_first_live_cutover_found": bool(
            (old_evidence.get("anchors") or {}).get("family_first_live_cutover")
        ),
