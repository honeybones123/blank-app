...
def main() -> int:
    ...
    checks = {
        ...
        "spacing_policy_represented": (no_valid_trace.get("SPACING_REDUCTION") or {}).get("candidate_count") == 6,
        "leg_policy_represented": (no_valid_trace.get("LEG_COUNT_INCREASE_RESTART_REINFORCEMENT_SEARCH") or {}).get("candidate_count") == 14,
        "bar_policy_represented": (no_valid_trace.get("BAR_SIZE_INCREASE") or {}).get("candidate_count") == 42,
        "depth_policy_represented": (no_valid_trace.get("DEPTH_INCREASE_RESTART_REINFORCEMENT_SEARCH") or {}).get("candidate_count") == 63,
        "width_policy_represented": (no_valid_trace.get("WIDTH_INCREASE_RESTART_REINFORCEMENT_SEARCH") or {}).get("candidate_count") == 63,
        "leg_restart_recorded": _restart_lanes_for(no_valid_trace, "LEG_COUNT_INCREASE_RESTART_REINFORCEMENT_SEARCH") == {("SPACING_REDUCTION",)},
        "bar_restart_recorded": _restart_lanes_for(no_valid_trace, "BAR_SIZE_INCREASE") == {("SPACING_REDUCTION", "LEG_COUNT_INCREASE_RESTART_REINFORCEMENT_SEARCH")},
        "depth_restart_recorded": _restart_lanes_for(no_valid_trace, "DEPTH_INCREASE_RESTART_REINFORCEMENT_SEARCH") == {("SPACING_REDUCTION", "LEG_COUNT_INCREASE_RESTART_REINFORCEMENT_SEARCH", "BAR_SIZE_INCREASE")},
        "width_restart_recorded": _restart_lanes_for(no_valid_trace, "WIDTH_INCREASE_RESTART_REINFORCEMENT_SEARCH") == {("SPACING_REDUCTION", "LEG_COUNT_INCREASE_RESTART_REINFORCEMENT_SEARCH", "BAR_SIZE_INCREASE")},
