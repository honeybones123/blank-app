...
def depth_reset_lane_main(script_path: Path) -> int:
    ...
    return _common_snapshot(
        ...
        specific_checks={
            ...
            "depth_change_restarts_spacing_and_bar_search": restart_lanes == ["SPACING_REDUCTION", "BAR_SIZE_INCREASE"],
...
def width_reset_lane_main(script_path: Path) -> int:
    ...
    return _common_snapshot(
        ...
        specific_checks={
            ...
            "width_change_restarts_spacing_and_bar_search": restart_lanes == ["SPACING_REDUCTION", "BAR_SIZE_INCREASE"],
...
def leg_count_lane_main(script_path: Path) -> int:
    ...
    restarts = [
        {
            ...
            "bar_size_restart": list(policy.get("restart_bar_size_labels") or []),
        }
    ...
    return _common_snapshot(
        ...
        specific_checks={
            ...
            "each_leg_count_restarts_bar_size_search": all(
                item["bar_size_restart"] == EXPECTED_BAR_SIZE_LABELS for item in restarts
            ),
        },
    )
