...
def _validate_contract_shape(contract: dict[str, Any]) -> list[str]:
    ...
    required_rule_fragments = [
        ...
        "Try the nearest legal reinforcement step before changing geometry.",
        "Progress diameter and count before adding a second reinforcement row.",
        "Use second-row reinforcement before depth growth.",
        "Do not jump to width while valid reinforcement or depth growth remains.",
