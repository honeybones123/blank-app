...
def main() -> int:
    ...
    inputs_surfaces = {
        "evaluate_loop": "def _evaluate(" in inputs_source or "evaluate_candidate_full(" in inputs_source,
        ...
        "bending_ladder_call": (
            "bending_family_strategy.contracted_repair_ladder_specs(" in inputs_source
            or "strategy.contracted_repair_ladder_specs(" in inputs_source
            or "contracted_repair_ladder_specs(" in inputs_source
        ),
    }
    checks = {
        ...
        "page_evaluation_loop_retained": (
            ...
            and inputs_surfaces["bending_family_strategy_dispatch"]
            and inputs_surfaces["bending_ladder_call"]
        ),
