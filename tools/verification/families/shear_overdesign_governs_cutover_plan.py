...
def _read_inputs_composition_surface() -> str:
    return "\n".join(
        ...
        for path in (
            ...
            "inputs_page_modules/app_bridge/auto_design_solver.py",
...
def main() -> int:
    ...
    checks = {
        ...
        "extracted_cleanup_surface_known": "_compute_shear_tightening_recommendation" in inputs_source
        and "generate_less_shear_reo_variants" in inputs_source,
        "zero_shear_anchor_known": "_try_shear_remove_links_tightening_recommendation" in inputs_source
        and "_shear_no_links_candidate_passes_code" in inputs_source,
        "candidate_evaluator_surface_known": "evaluate_candidate_full(" in inputs_source
        and "_evaluate_candidate_fast(" in inputs_source,
        "shared_cta_publication_apply_have_current_owners": (
    ...
    snapshot = {
        ...
        "replacement_boundary": {
            ...
            "old_page_local_logic": "inputs_page_modules guidance/recommendation cleanup compatibility surfaces",
            "new_authority": "design_brain.families.shear_overdesign_governs.runtime.run_shear_overdesign_governs_runtime",
            "shared_execution_surface": "extracted evaluator / CTA / publication / apply / UI plumbing",
        },
