...
def main() -> int:
    ...
    page_evaluation_loop_retained = (
        (inputs_surface["def _evaluate("] or inputs_surface["evaluate_candidate_full_for_app_bridge("] or "evaluate_candidate_full(" in inputs_source)
        and inputs_surface["_evaluate_auto_design_candidate("]
        and inputs_surface['family_strategy_for("BENDING_FAIL_GOVERNS")']
        and inputs_surface["contracted_repair_ladder_specs("]
