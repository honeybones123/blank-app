...
def build_payload() -> dict[str, Any]:
    ...
    allowance_start, allowance_end, allowance_helper = _function_segment(
        source,
        "_resolve_auto_design_partial_commit_allowance_coordinator",
    )
    ...
    _, _, commit_start_dispatch = _function_segment(
        source,
    ...
    static_checks = {
        ...
        "helper_delegates_partial_commit_allowance": (
            "_resolve_auto_design_partial_commit_allowance_coordinator(" in helper
        ),
        "helper_preserves_rescue_gate": "_rescue_bootstrap_partial_commit_allowed(" in allowance_helper,
        ...
        "commit_orchestration_owns_commit_path": (
            "_dispatch_auto_design_commit_start_from_commit_orchestration_coordinator("
            in commit_body
            and "_prepare_auto_design_commit_start_coordinator("
            in commit_start_dispatch
            and "_apply_auto_design_commit_write_audit_setup_coordinator("
            in commit_body
        ),
    ...
    return {
        ...
        "allowance_segment": {
            "function": "_resolve_auto_design_partial_commit_allowance_coordinator",
            "start_line": allowance_start,
            "end_line": allowance_end,
            "line_count": allowance_end - allowance_start + 1,
        },
