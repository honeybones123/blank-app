...
NON_C_LIVE_GUARD_TOKENS: dict[str, str] = {
    "controller_compute_resolution_source": "_pre_resolver_controller_response.final_compute_resolution or {}",
    "raw_compute_resolver_item": 'final_compute_resolution.get("item")',
    "raw_compute_render_reason": 'final_compute_resolution.get("render_reason")',
    "raw_compute_state_fingerprint": 'final_compute_resolution.get("state_fingerprint")',
    "late_evidence_guard": "_late_contract_disabled_or_mismatched",
    "late_evidence_acceptance": "_late_evidence_acceptance",
    "late_rebound_contract_source": (
        '_late_rebound_contract = dict((_late_rebound_item or {}).get("button_contract") or {})'
    ),
    "late_rebound_updates_source": '_late_rebound_contract.get("updates")',
    "post_evidence_guard": "_post_evidence_disabled_or_mismatched",
    "post_core_mismatch": "_post_core_mismatch",
    "post_evidence_rebound_source": (
        "_post_evidence_rebound = _publish_final_visible_design_guide_contract_binding("
    ),
    "collapsed_pre_resolver_mutation": "collapsed_guidance_items[0] = dict(_post_evidence_rebound)",
}

HELPER_REQUIRED_TOKENS = {
    "proof_hash": '"proof_hash": proof_hash',
    "compatibility_only": '"compatibility_only": True',
    "proof_only": '"proof_only": True',
    "cannot_override": '"can_override_final_publication": False',
    "authority": '"final_publication_authority": "FinalDesignGuidePublication"',
    ...
    "row_hash": '"final_publication_compute_debug_restamp_metadata_hash"',
    "global_cannot_override": '"final_publication_compute_debug_restamp_metadata_can_override_publication"',
}
        ...
        rows.append(
            {
                ...
                "proof_hash_attached": "proof_hash" in source and row_line is not None,
                "compatibility_only": "compatibility_only" in source and row_line is not None,
                "proof_only": "proof_only" in source and row_line is not None,
...
def main() -> int:
    ...
    helper_call_count = source.count("_mark_compute_debug_restamp_metadata_compatibility_only(") - 1
