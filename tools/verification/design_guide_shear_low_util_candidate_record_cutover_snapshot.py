...
def _checks(capture: dict[str, Any]) -> dict[str, bool]:
    ...
    return {
        ...
        or (
            ...
            and source_checks.get("controller_has_record_builder") is True
            and source_checks.get("legacy_direct_candidate_evaluation_removed") is True
            and source_checks.get("old_inline_no_link_policy_removed") is True
        ),
