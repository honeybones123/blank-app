...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_delegates_candidate_fallback_pool_trace": (
            "_handle_one_click_solver_candidate_fallback_pool_trace_coordinator(" in selection_state_body
        ),
        "selection_state_rehydrates_candidate_fallback_state": (
            'scored = candidate_fallback_pool_trace_state["scored"]' in selection_state_body
            and '"fallback_next_hop_injected": fallback_next_hop_injected' in selection_state_body
            and '"fallback_next_hop_reason": fallback_next_hop_reason' in selection_state_body
        ),
