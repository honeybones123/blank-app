...
EXPECTED_COMPUTE_PATHS = {
    "compute_stage_final_visible_resolver": "final_compute_resolution = resolve_final_visible_design_guide_item(",
    "compute_late_evidence_contract_rebound": "_late_rebound_item = _publish_final_visible_design_guide_contract_binding(",
    "post_core_evidence_rebound": "_post_evidence_rebound = _publish_final_visible_design_guide_contract_binding(",
}
