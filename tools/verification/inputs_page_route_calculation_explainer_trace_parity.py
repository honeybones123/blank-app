...
def _run_route(module: Any) -> dict[str, Any]:
    ...
    try:
        ...
        module.render_inputs_calculation_explainer_trace_coordinator(
            **rows,
            results_version=7,
...
def main() -> int:
    ...
    route_result = _run_route(route_bridge)
    ...
    checks = {
        ...
        "route_delegates_to_calculation_trace_module": (
            "render_inputs_calculation_explainer_trace_module(" in route_source
        ),
        "module_builds_calculation_view_model": (
            "build_inputs_calculation_explainer_view_model(" in module_source
        ),
        "route_does_not_delegate_calc_trace_to_old_page": (
            "_legacy_inputs_page.render_inputs_calculation_explainer_trace_coordinator" not in route_source
        ),
    }
