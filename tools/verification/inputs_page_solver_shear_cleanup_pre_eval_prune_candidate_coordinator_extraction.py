...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_delegates_shear_cleanup_prune_branch": (
            "_handle_one_click_solver_shear_cleanup_pre_eval_prune_candidate_coordinator(" in pre_scoring_body
        ),
        "solver_rehydrates_counter": (
            'rejected_as_non_governing_cleanup = shear_cleanup_prune_state[' in pre_scoring_body
        ),
        "solver_preserves_continue_gate": 'if shear_cleanup_prune_state["should_continue"]:' in pre_scoring_body,
