...
def main() -> int:
    ...
    def _fake_extracted(candidate: dict, mode_config: dict, seed_candidate: dict, *, runtime) -> dict:
        call_record.update(
            {
                ...
                "bound_objective_util": runtime.candidate_objective_util is bridge._candidate_objective_util,
                "bound_practicality": runtime.shear_candidate_practicality_metrics
                is bridge._shear_candidate_practicality_metrics,
                "bound_ductility": runtime.candidate_ductility_governs is bridge._candidate_ductility_governs,
            }
        )
