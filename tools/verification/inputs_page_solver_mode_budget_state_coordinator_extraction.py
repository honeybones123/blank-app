...
def build_payload() -> dict[str, Any]:
    ...
    _, _, after_initial_body = _function_segment(
        source,
    ...
    static_checks = {
        ...
        "solver_delegates_mode_budget_state": "_prepare_one_click_solver_mode_budget_state_coordinator("
        in after_initial_body,
        "runtime_setup_rehydrates_mode_budget_state_fields": (
            "runtime_ready_scope.update(solver_mode_budget_state)"
            in after_mode_budget_body
            and '"working": runtime_setup_scope["working"]' in source
            and '"mode_config": runtime_setup_scope["mode_config"]' in source
            and '"step_committable_eval_trace": runtime_setup_scope[' in source
        ),
