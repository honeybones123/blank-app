...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "helper_preserves_no_bars_message": "Add longitudinal reinforcement before running auto-design." in helper,
        ...
        "run_keeps_solver_after_blocked_path": "_solve_one_click_to_target(" in run_body,
    }
    status = "PASS"
