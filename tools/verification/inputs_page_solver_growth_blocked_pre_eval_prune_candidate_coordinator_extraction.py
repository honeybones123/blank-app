...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_delegates_growth_prune_branch": (
            "_handle_one_click_solver_growth_blocked_pre_eval_prune_candidate_coordinator(" in pre_scoring_body
        ),
        "solver_rehydrates_counter": (
            'growth_candidates_rejected_in_tightening = growth_prune_state[' in pre_scoring_body
        ),
        "solver_preserves_continue_gate": 'if growth_prune_state["should_continue"]:' in pre_scoring_body,
