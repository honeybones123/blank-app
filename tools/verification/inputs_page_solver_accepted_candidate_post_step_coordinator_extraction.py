...
def build_payload() -> dict[str, Any]:
    ...
    _, _, apply_flow = _function_segment(
        source,
        "_handle_one_click_solver_accepted_candidate_apply_flow_coordinator",
    )
    ...
    static_checks = {
        ...
        "aggregate_delegates_apply_first": (
            aggregate.find("_handle_one_click_solver_accepted_candidate_apply_flow_coordinator(")
            ...
            and "_handle_one_click_solver_apply_selected_candidate_and_evaluate_coordinator("
            in apply_flow
        ),
        ...
        "aggregate_preserves_apply_break": (
            'if apply_selected_candidate_state["should_break"]:' in apply_flow
