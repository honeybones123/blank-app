...
def _run_case(name: str, initial_state: dict[str, Any]) -> dict[str, Any]:
    ...
    original_legacy_set_shared = legacy_inputs_page.set_shared
    ...
    try:
        ...
        legacy_inputs_page.set_shared = legacy_set_shared
        bridge.set_shared = bridge_set_shared
        legacy_value = bool(legacy_inputs_page.run_inputs_layer4_pre_hydrate_shear_normalisation())
        ...
        legacy_inputs_page.set_shared = original_legacy_set_shared
