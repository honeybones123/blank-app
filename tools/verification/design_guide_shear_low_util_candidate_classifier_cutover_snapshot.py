    ...
    return {
        ...
        "source_checks": {
            ...
            "classifier_called_in_page_loop": (
                "classify_design_guide_shear_low_util_cleanup_candidate(" in inputs_source
                or "classify_design_guide_shear_low_util_cleanup_candidate" in controller_source
            ),
            ...
            or "evaluate_auto_design_candidate" in inputs_source,
