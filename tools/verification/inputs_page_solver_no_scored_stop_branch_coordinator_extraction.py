...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_rehydrates_selection_or_stop_state_before_break": (
            'if scored_candidate_selection_state["should_break"]:' in post_selection_body
            and "_build_one_click_solver_selection_stop_iteration_state_coordinator("
            in post_selection_body
            and '"stop_reason": scored_candidate_selection_state["stop_reason"]'
            in selection_stop_packer
            and '"status": scored_candidate_selection_state["status"]'
            in selection_stop_packer
            and '"final_distance_to_band": scored_candidate_selection_state['
            in selection_stop_packer
        ),
