            ...
            () => {
              ...
              const attrMap = (el) => {
                ...
                for (const attr of Array.from(el.attributes)) {
                  ...
                  if (/final|publication|authority|design|guide|card|cta|button|apply|state|hash/i.test(key + " " + val)) {
              ...
              const designGuideCards = Array.from(document.querySelectorAll("[data-testid='design-guide-card']"))
                .filter(visible)
                .map(elementPayload);
                ...
                page.evaluate(
                    ...
                    () => {
                      ...
                      return {
                        ...
                        hasDesignGuide: hasProductDesignGuide,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            page.goto(_query(base_url, {"page": "inputs", "browser_recipe": args.recipe}), wait_until="domcontentloaded", timeout=90_000)
            try:
