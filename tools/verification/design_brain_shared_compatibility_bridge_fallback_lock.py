...
def _source_checks() -> dict[str, bool]:
    ...
    return {
        ...
        "fallback_shells_marked_non_authoritative": "final_publication_cta_non_authoritative_shell" in inputs_source
        and "final_publication_display_non_authoritative_shell" in inputs_source,
        "fallback_shells_marked_fallback_only": "fallback_only=True" in inputs_source,
        "compatibility_markers_remain_explicit": "compatibility_only" in inputs_source
        and "legacy_non_authoritative" in inputs_source,
    }
