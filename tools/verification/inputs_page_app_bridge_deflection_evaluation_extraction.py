"""Verify app-bridge deflection evaluation extraction."""
...
def main() -> int:
    ...
    bridge_node = _function_node(bridge_source, "_evaluate_deflection_with_state_for_app_bridge")
    module_node = _function_node(module_source, "_evaluate_deflection_with_state_for_app_bridge")
    ...
    checks: dict[str, bool] = {
        ...
        "bridge_delegates_to_extracted_module": "_evaluate_deflection_with_state_for_app_bridge_extracted" in bridge_body,
    ...
    original = bridge._evaluate_deflection_with_state_for_app_bridge_extracted
    call_record: dict = {}
        ...
        call_record.update(
            {
                ...
                "bound_status": getattr(extracted, "_status_from_candidate_util_for_app_bridge", None)
                is bridge._status_from_candidate_util_for_app_bridge,
    ...
    try:
        bridge._evaluate_deflection_with_state_for_app_bridge_extracted = _fake_extracted
        returned = bridge._evaluate_deflection_with_state_for_app_bridge(
            {"D": 650},
            bottom_updates={"Ast_bot": 1200},
        )
    finally:
        bridge._evaluate_deflection_with_state_for_app_bridge_extracted = original
    ...
    checks["bridge_runtime_binds_module_globals"] = (
        ...
        and getattr(extracted, "_status_from_candidate_util_for_app_bridge", None)
        is bridge._status_from_candidate_util_for_app_bridge
    ...
    json_path = ARTIFACTS / f"inputs_page_app_bridge_deflection_evaluation_extraction_{stamp}.json"
    report_path = AUDITS / f"inputs_page_app_bridge_deflection_evaluation_extraction_{stamp}.md"
    json_path.write_text(json.dumps(result, indent=2, sort_keys=True), encoding="utf-8")
    report_path.write_text(
        "\n".join(
            [
                "# Inputs Page App Bridge Deflection Evaluation Extraction",
                "",
