...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_rehydrates_candidate_collection_fields": 'raw_candidates = candidate_collection_state["raw_candidates"]'
        in candidate_pipeline_body
        and 'use_governing_domain_candidates = candidate_collection_state["use_governing_domain_candidates"]'
        in candidate_pipeline_body
        and 'combined_candidates_considered_for_shear = candidate_collection_state["combined_candidates_considered_for_shear"]'
        in candidate_pipeline_body,
