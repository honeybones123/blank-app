...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_rehydrates_scoring_start_fields": (
            'cur_has_td = iteration_scoring_start_state["cur_has_td"]' in candidate_pipeline_body
            and 'cur_required_fail_count = iteration_scoring_start_state["cur_required_fail_count"]' in candidate_pipeline_body
            and 'scored: list[dict] = iteration_scoring_start_state["scored"]' in candidate_pipeline_body
        ),
