...
REQUIRED_INPUTS_TOKENS = {
    ...
    "authority_constant": '"authority": _FINAL_PUBLICATION_CTA_AUTHORITY',
    "authority_builder": "def _final_publication_cta_authority_payload(",
    "authority_stamper": "def _final_publication_cta_authority_payload(",
    "payload_audit_hash": "final_publication_cta_hash",
    "contract_authority_marker": "_FINAL_PUBLICATION_CTA_AUTHORITY",
    "contract_match_marker": '"authority": _FINAL_PUBLICATION_CTA_AUTHORITY',
    "binding_stamper_call": "_final_publication_cta_authority_payload(",
...
def _build_snapshot() -> dict[str, Any]:
    inputs_source = "\n".join(
        ...
        for path in (INPUTS_PAGE, ROUTE_COORDINATORS, APPLY_ROUTING, *CURRENT_CTA_FILES)
        if path.exists()
    )
