...
def build_payload() -> dict[str, Any]:
    ...
    sort_start, sort_end, sort_loop = _function_segment(
        inputs_source,
    ...
    page_delegates = sort_loop.count("_resolve_target_band_candidate_sort_key(") >= 2
    old_tuple_literals_removed = "sort_key = (" not in target_loop and "sort_key = (" not in sort_loop
