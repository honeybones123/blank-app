...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "helper_builds_debug": "dbg = {" in helper,
        ...
        "helper_delegates_payload_with_debug": (
            ...
            and "final_solver_return_scope=locals()" in helper
        ),
        ...
        "finalization_delegates_final_trace_and_return_tail": (
            "return _dispatch_one_click_solver_final_trace_return_coordinator(" in finalization
        ),
