...
def _checks(capture: dict[str, Any]) -> dict[str, bool]:
    ...
    return {
        ...
        or (
            ...
            and source_checks.get("old_explicit_fail_helper_removed_from_target") is True
            and source_checks.get("old_required_checks_helper_removed_from_target") is True
        ),
