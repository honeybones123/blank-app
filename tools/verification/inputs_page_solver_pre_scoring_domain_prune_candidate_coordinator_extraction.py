...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_delegates_pre_scoring_domain_prune_branch": (
            "_handle_one_click_solver_pre_scoring_domain_prune_candidate_coordinator(" in solve_body
        ),
        "solver_rehydrates_flags": (
            'pruned_non_shear_family_count = pre_scoring_domain_prune_state[' in solve_body
            and 'domain_match_prune_used = pre_scoring_domain_prune_state["domain_match_prune_used"]' in solve_body
            and 'shear_prune_rule_source = pre_scoring_domain_prune_state["shear_prune_rule_source"]' in solve_body
        ),
        "solver_preserves_continue_gate": 'if pre_scoring_domain_prune_state["should_continue"]:' in solve_body,
