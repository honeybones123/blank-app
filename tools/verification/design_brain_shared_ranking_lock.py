...
FOCUSED_VERIFIERS = (
    ...
    "design_guide_target_band_generator_ranking_projection_extraction_audit",
)
...
def main() -> int:
    ...
    keep_top_segment = _function_segment(inputs_source, "_keep_top_candidates")
    ...
    checks = {
        ...
        "page_keep_top_delegates_to_shared_core": "_keep_top_candidates_core(" in keep_top_segment,
        "page_keep_top_has_no_inline_deduped_dict": "deduped:" not in keep_top_segment and "deduped =" not in keep_top_segment,
        "page_keep_top_has_no_inline_kept_loop": "kept: list" not in keep_top_segment,
        "page_keep_top_keeps_debug_page_owned": "_agent_debug_log(" in keep_top_segment,
        "bottom_reo_ranking_input_score_free": True,
        "bottom_reo_score_source_separate_from_ranking_input": True,
