...
DELEGATED_BOUNDARIES = {
    ...
    "_resolve_design_guide_guidance_cache_result": (
        "build_inputs_design_guide_guidance_cache_result",
        "build_inputs_design_guide_cached_debug_trust_decision",
    ),
    "_build_design_guide_guidance_cache_write_plan": ("build_inputs_design_guide_guidance_cache_write_plan",),
...
APPROVED_PAGE_SHELL_BOUNDARIES = {
    "session_mutation": (
        ...
        "_build_design_guide_guidance_cache_write_plan",
