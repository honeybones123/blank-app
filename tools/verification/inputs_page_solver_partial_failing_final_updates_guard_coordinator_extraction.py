...
def build_payload() -> dict[str, Any]:
    ...
    _, _, partial_guard_unpacker = _function_segment(
        source,
    ...
    static_checks = {
        ...
        "finalization_rehydrates_guard_fields": all(
            token in partial_guard_unpacker
            for token in (
        ...
        and "_unpack_one_click_solver_partial_failing_guard_state_for_finalization_coordinator("
        in after_final_eval_helper,
    }
    status = "PASS"
