...
def main() -> int:
    ...
    fn = _function_by_name(tree, "render_inputs_calculation_explainer_trace_coordinator")
    function_name = "render_inputs_calculation_explainer_trace_coordinator"
    checks: dict[str, Any] = {
    ...
    function_source = ""
    if fn is not None:
        function_source = _source_for_node(source, fn)
