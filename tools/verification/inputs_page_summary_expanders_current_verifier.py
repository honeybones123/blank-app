...
def main() -> int:
    ...
    call_text = "render_inputs_summary_expanders_and_tables_current_coordinator("
    ...
    finalization_index = summary_owner_source.find("render_inputs_summary_row_finalization_current_coordinator(")
    ...
    render_summary_call_index = container_source.find("render_summary_table(st.session_state.get(RESULT_CACHE_KEY))")
    container_call_index = summary_owner_source.find("render_inputs_summary_container_current_coordinator(")
