...
def _capture() -> dict[str, Any]:
    ...
    controller_owned_compute_selection_inputs = (
        controller_handoff_boundary_present
        and "class DesignGuideControllerComputePublicationHandoffRequest" in controller_source
        and "class DesignGuideControllerComputePublicationHandoffResponse" in controller_source
        and "run_design_guide_controller_compute_publication_handoff_trace_only" in controller_source
    )
    ...
    return {
        ...
        "controller_owned_compute_selection_inputs": controller_owned_compute_selection_inputs,
        "latest_locks": {
...
def _checks(capture: dict[str, Any]) -> dict[str, bool]:
    ...
    return {
        ...
        "live_compute_path_has_selection_inputs_or_legacy_resolver_deleted": (
            ...
            or capture.get("controller_owned_compute_selection_inputs") is True
