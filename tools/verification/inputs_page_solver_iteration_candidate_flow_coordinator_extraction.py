...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "pre_selection_preserves_candidate_evaluation_order": all(
            token in pre_selection for token in pre_selection_tokens
        )
        and [pre_selection.index(token) for token in pre_selection_tokens]
        == sorted(pre_selection.index(token) for token in pre_selection_tokens),
        ...
        "pre_selection_delegates_state_packer": (
            "_build_one_click_solver_pre_selection_candidate_evaluation_state_coordinator(" in pre_selection
        ),
