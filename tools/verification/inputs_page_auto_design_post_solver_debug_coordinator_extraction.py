...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "run_delegates_post_solver_tail": (
            "_run_one_click_auto_design_solver_and_final_response_coordinator(" in run_body
        ),
        "tail_delegates_post_solver_debug": "_build_auto_design_post_solver_debug_coordinator(" in tail_body,
        "run_delegates_post_solver_commit_orchestration": (
            "_run_auto_design_post_solver_commit_orchestration_coordinator(" in tail_body
        ),
