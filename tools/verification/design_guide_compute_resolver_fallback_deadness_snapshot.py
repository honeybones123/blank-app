...
def _capture() -> dict[str, Any]:
    ...
    checks = {
        ...
        "fallback_usage_stamped": FALLBACK_USED_KEY in source and CONTROLLER_USED_KEY in source,
    ...
    fallback_dead_now = all(checks.values()) and not fallback_shell_present
