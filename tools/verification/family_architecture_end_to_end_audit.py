...
FAMILIES: tuple[FamilyConfig, ...] = (
    FamilyConfig(
        ...
        ("bending_fail_governs_repair_regression_*.json",),
    ),
    FamilyConfig(
        "SHEAR_FAIL_GOVERNS",
...
GLOBAL_GATES: tuple[tuple[str, str], ...] = (
    ...
    ("design_guide_render_bridge_lock", "design_guide_render_bridge_lock_*.json"),
    ("design_guide_compute_resolver_publication_bridge_lock", "design_guide_compute_resolver_publication_bridge_lock_*.json"),
...
def _direct_source_checks() -> dict[str, Any]:
    ...
    return {
        ...
        "inputs_page_still_owns_apply_routing": "_queue_primary_design_guide_button_action" in inputs
        and "_record_rendered_design_guide_primary_apply_payload" in inputs,
        "inputs_page_still_renders_ui": "_render_fast_design_guidance_panel" in inputs
        and "st.markdown" in inputs,
