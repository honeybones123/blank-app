...
def _capture() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "inputs_uses_final_publication_cta_authority": '_FINAL_PUBLICATION_CTA_AUTHORITY = "FinalDesignGuidePublication.cta"'
        in inputs_source,
        "inputs_uses_final_publication_display_authority": '_FINAL_PUBLICATION_DISPLAY_AUTHORITY = "FinalDesignGuidePublication.display"'
        in inputs_source,
        "inputs_imports_cta_source_precedence_core": "select_design_guide_button_contract_source_precedence"
        in inputs_source,
    }
