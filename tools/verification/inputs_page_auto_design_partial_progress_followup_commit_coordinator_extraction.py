...
def build_payload() -> dict[str, Any]:
    ...
    _, _, rollback_helper = _function_segment(
        source,
        "_handle_auto_design_partial_followup_rejected_rollback_coordinator",
    )
    _, _, result_helper = _function_segment(
        source,
        "_build_auto_design_partial_progress_followup_commit_result_state_coordinator",
    )
    ...
    static_checks = {
        ...
        "helper_preserves_rollback_source": "rollback_followup_failed_audit" in rollback_helper,
        ...
        "helper_returns_runner_state": "_build_auto_design_partial_progress_followup_commit_result_state_coordinator(" in helper
        and '"stop_reason": followup_scope["stop_reason"]' in result_helper
        and '"fin_u": followup_scope["fin_u"]' in result_helper
        and '"reached": bool(followup_scope["reached"])' in result_helper,
