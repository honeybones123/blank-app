...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "dispatch_response_branches_are_delegated": "_return_auto_design_ready_response_coordinator(" in dispatch_body
        and "_return_auto_design_already_in_band_response_coordinator(" in dispatch_body,
    }
    status = "PASS"
