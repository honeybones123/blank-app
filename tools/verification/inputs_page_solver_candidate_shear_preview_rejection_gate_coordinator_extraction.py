...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "aggregate_rehydrates_counters_and_continue": (
            ...
            and '"should_continue": shear_preview_rejection_gate_state["should_continue"]' in aggregate_body
        ),
        ...
        "solver_rehydrates_aggregate_counters_and_continue": (
            'rejected_as_spacing_too_weak = shear_truth_preview_gate_state[' in scoring_loop_body
            and 'rejected_as_web_crushing_marginal = shear_truth_preview_gate_state[' in scoring_loop_body
            and 'rejected_as_impractical_shear_layout = shear_truth_preview_gate_state[' in scoring_loop_body
            and 'if shear_truth_preview_gate_state["should_continue"]:' in scoring_loop_body
        ),
