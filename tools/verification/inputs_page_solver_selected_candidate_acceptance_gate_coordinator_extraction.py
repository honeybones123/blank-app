...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_rehydrates_best_distance_and_break": (
            'best = scored_candidate_selection_state["best"]' in solve_body
            and 'best_distance_to_band_this_iteration = scored_candidate_selection_state[' in solve_body
            and 'if scored_candidate_selection_state["should_break"]:' in solve_body
        ),
