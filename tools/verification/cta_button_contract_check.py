...
SNAPSHOT_PATH = ROOT / "tools" / "verification" / "compute_cta_button_source_precedence_snapshot.py"
...
def _run_snapshot() -> dict[str, Any]:
    command = [sys.executable, "tools/verification/compute_cta_button_source_precedence_snapshot.py"]
