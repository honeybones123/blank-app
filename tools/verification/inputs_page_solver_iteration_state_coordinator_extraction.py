...
def build_payload() -> dict[str, Any]:
    ...
    _, _, runtime_setup_after_mode_budget_body = _function_segment(
        source,
    ...
    static_checks = {
        ...
        in runtime_setup_after_mode_budget_body,
        "runtime_setup_delegates_ready_state_packing": (
            "_build_one_click_solver_runtime_setup_ready_state_coordinator(" in runtime_setup_after_mode_budget_body
        ),
