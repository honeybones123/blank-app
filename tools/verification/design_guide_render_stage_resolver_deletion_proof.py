...
def _replacement_coverage(*, input_source: str, final_source: str) -> dict[str, dict[str, Any]]:
    return {
        ...
        "overview": {
            ...
            "source": "existing _dg_overview fallback; not final publication authority",
        },
        "design_brain_result": {
            "covered": (
                'guidance_debug.get("design_brain_result")' in input_source
                and '_final_visible_resolution.get("design_brain_result")' in input_source
            ),
        ...
        "debug": {
            "covered": "final_publication_verifier_payload" in input_source
...
def _build_snapshot() -> dict[str, Any]:
    ...
    source_guards = {
        ...
        "compute_resolver_callsite_still_present": 80926 in compute_resolver_lines
        or "final_compute_resolution = resolve_final_visible_design_guide_item(" in input_source,
        ...
        "session_debug_fallback_non_authoritative": (
            "legacy_non_authoritative" in input_source
            and "final_publication_authority_hash" in input_source
