...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "loop_gate_dispatch_delegates_iteration_gate": (
            "_prepare_one_click_solver_iteration_gate_state_coordinator("
            in loop_gate_dispatch
            and "iteration_loop_scope[" in loop_gate_dispatch
        ),
        ...
        "helper_uses_explicit_trace_callback": 'trace_callback=iteration_loop_scope["trace_callback"]'
        in loop_gate_dispatch
        and "trace_callback=_t" not in helper
        and "trace_callback=_t" not in loop_gate_dispatch,
