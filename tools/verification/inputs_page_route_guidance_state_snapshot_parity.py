...
def main() -> int:
    ...
    cases = {
        ...
        "design_guide_proof_keys_preserved": _case_result(
            "design_guide_proof_keys_preserved",
            {
                "locked_no_repair": True,
                "locked_repair_blocked": True,
                "all_repair_paths_locked": True,
                "repair_blocked_by_lock": True,
    ...
    proof_case = cases["design_guide_proof_keys_preserved"]["route"]
    ...
    checks = {
        ...
        "design_guide_proof_keys_preserved": all(
            proof_case.get(key) is True
            for key in (
                "locked_no_repair",
