...
def _payload_cases() -> dict[str, dict[str, Any]]:
    return {
        ...
        "distributed_safe_discrete_terminal_stop": {
            "item": {
                "selected_family_id": "BENDING_FAIL_GOVERNS",
                "published_family_id": "BENDING_FAIL_GOVERNS",
                ...
                "summary_line": "All required checks pass; the closest safe discrete step was accepted.",
                "post_click_design_guide_state": "optimal",
                "blocking_reason": (
                    "No safe executor-backed target-band candidate was found in the searched "
                    "catalogue; the selected candidate is the closest safe available step."
                ),
                "candidate_search_evidence": {
                    ...
                    "closest_safe_candidate_util": 0.963,
                },
                "button_contract": {
                    # Reproduce the live ordering hazard: the pre-guard item
                    # still carries the just-applied action, while the
                    # authoritative post-click evidence is already terminal.
                    "enabled": True,
                    "actionable": True,
                    "action_type": "apply_resolved_candidate",
                    "family": "BENDING_FAIL_GOVERNS",
                    "updates": {"lig_d": 16, "s_lig": 175},
                    "source_candidate_id": "stale-before-terminal-guard",
            ...
            "expected": {
                ...
                "cta_label": None,
                "cta_disabled_reason": "terminal_pass_no_action",
                "display_title": "Optional refinement - shear reinforcement is conservative",
                "display_badge": "PASS",
                "display_summary": "All required checks pass; the closest safe discrete step was accepted.",
            },
        },
        "distributed_blocked": {
            "item": {
            ...
            "expected": {
                ...
                "display_summary": (
                    "No repair is executable. No safe one-click repair was "
                    "found. no_valid_shear_repair"
                ),
            },
        },
        "distributed_error": {
