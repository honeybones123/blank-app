...
def main() -> int:
    ...
    call_text = "render_inputs_summary_pipeline_current_coordinator("
    if render_inputs_source.count(call_text) != 1:
        failures.append(f"render_inputs_summary_pipeline_call_count:{render_inputs_source.count(call_text)}")
