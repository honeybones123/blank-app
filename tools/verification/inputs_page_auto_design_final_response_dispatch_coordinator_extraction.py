...
def build_payload() -> dict[str, Any]:
    ...
    terminal_start, terminal_end, terminal_helper = _function_segment(
        source,
    ...
    final_tail_start, final_tail_end, final_tail = _function_segment(
        source,
    ...
    static_checks = {
        ...
        < helper.find("_dispatch_auto_design_terminal_status_response_from_final_response_coordinator(")
        and terminal_helper.find('if out_status == "failed":')
        < terminal_helper.find('if out_status == "no_action" and stop_reason == "already_in_band":')
        < terminal_helper.find("if final_updates:")
        < terminal_helper.find("_return_auto_design_default_no_action_response_coordinator("),
        ...
        "run_delegates_final_tail": (
            ...
            and "_finish_auto_design_post_current_eval_and_dispatch_coordinator(" in final_tail
        ),
    ...
    return {
        ...
        "terminal_segment": {
            "function": "_dispatch_auto_design_terminal_status_response_from_final_response_coordinator",
            "start_line": terminal_start,
            "end_line": terminal_end,
            "line_count": terminal_end - terminal_start + 1,
        },
        "tail_segment": {
        ...
        "final_tail_segment": {
            "function": "_run_one_click_auto_design_solver_and_final_response_coordinator",
            "start_line": final_tail_start,
            "end_line": final_tail_end,
            "line_count": final_tail_end - final_tail_start + 1,
        },
        "run_segment": {
