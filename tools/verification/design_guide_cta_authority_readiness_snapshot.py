...
CTA_AUTHORITY_PATHS: list[dict[str, Any]] = [
    ...
    {
        "path": "apply_payload",
        "owner_file": "inputs_page_modules/design_guide/primary_apply_payload.py",
        "function_or_symbol": "_build_design_guide_primary_apply_payload",
        "required_tokens": ["def _build_design_guide_primary_apply_payload(", "updates", "state_fingerprint"],
    ...
    },
    {
        ...
        "owner_file": "inputs_page_modules/design_guide/primary_apply_payload_recorder.py",
        "function_or_symbol": "_record_rendered_design_guide_primary_apply_payload",
        "required_tokens": ["def _record_rendered_design_guide_primary_apply_payload(", "stale_apply_payload_blocked"],
    ...
    },
    {
        ...
        "owner_file": "inputs_page_modules/design_guide/executor_actionability_contract.py",
        "function_or_symbol": "def _guidance_executor_actionability_contract(",
        "required_tokens": ["def _guidance_executor_actionability_contract(", "primary_efficiency_card_not_executor_backed"],
    ...
    },
    {
        ...
        "owner_file": "inputs_application/page_runtime/common.py",
        "function_or_symbol": "def _consume_design_guide_component_cta_value(",
        "required_tokens": ["def _consume_design_guide_component_cta_value(", "expected_fingerprint", "current_fingerprint"],
    ...
    {
        "path": "one_click_action_queue",
        "owner_file": "inputs_page_modules/design_guide/primary_button_queue.py",
        "function_or_symbol": "def _queue_primary_design_guide_button_action(",
        "required_tokens": [
        ...
        "current_authority_role": "captures the primary one-click CTA as queued intent without executing Apply inside the callback",
        "cta_fields": ["one_click_action_handoff", "apply_payload_summary"],
        "can_be_moved_now": False,
        "reason_if_no": "One-click intent capture remains a page/session side effect.",
        "required_parity_proof": "compare object.cta.one_click_action_handoff to the queued button action payload and trace",
    },
    {
        "path": "one_click_action_fragment_consumer",
        "owner_file": "inputs_application/engineering_workspace.py",
        "function_or_symbol": "def render_inputs_design_guide_fragment_section(",
        "required_tokens": [
            "def render_inputs_design_guide_fragment_section(",
            "runtime.handle_pending_apply()",
        ],
        "current_authority_role": "consumes queued CTA intent at Design Guide fragment entry through the typed Apply runtime",
        "cta_fields": ["one_click_action_handoff", "apply_payload_summary"],
        "can_be_moved_now": False,
        "reason_if_no": "The fragment entry is the legal rerun boundary for queued Apply intent.",
        "required_parity_proof": "prove the queued payload is consumed once before publication rendering",
    },
    {
        "path": "one_click_action_apply_commit",
        "owner_file": "inputs_page.py",
        "function_or_symbol": "def handle_inputs_apply_buttons(",
        "required_tokens": [
            "def handle_inputs_apply_buttons(",
            "apply_store.consume_request",
        ],
        "current_authority_role": "commits queued typed Apply updates and requests the authoritative app rerun",
        "cta_fields": ["one_click_action_handoff", "apply_payload_summary"],
        "can_be_moved_now": False,
        "reason_if_no": "Apply commit and app-scope rerun remain page/application side effects.",
        "required_parity_proof": "prove queued canonical updates reach committed shared state before the app rerun",
    },
    {
        "path": "source_precedence",
        "owner_file": "inputs_page_modules/design_guide/current_coordinators.py",
        "function_or_symbol": "_resolve_design_guide_button_contract_source_precedence",
        "required_tokens": ["winning_button_contract_source", "winning_update_payload_source"],
