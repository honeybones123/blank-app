...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "helper_delegates_fallback_before_selection": (
            "_handle_one_click_solver_candidate_fallback_pool_trace_coordinator(" in helper
            and "_handle_one_click_solver_candidate_selection_or_stop_coordinator(" in helper
            and helper.index("_handle_one_click_solver_candidate_fallback_pool_trace_coordinator(")
            < helper.index("_handle_one_click_solver_candidate_selection_or_stop_coordinator(")
        ),
        "helper_preserves_fallback_metadata": (
            'fallback_next_hop_injected = candidate_fallback_pool_trace_state[' in helper
            and '"fallback_next_hop_injected": fallback_next_hop_injected' in helper
            and '"fallback_next_hop_reason": fallback_next_hop_reason' in helper
        ),
