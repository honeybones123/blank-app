...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_rehydrates_initial_state_fields": (
            '"rid": solver_initial_state["rid"]' in after_initial_body
            and '"initial_snapshot": solver_initial_state["initial_snapshot"]'
            in after_initial_body
            and '"initial_stop_reason": solver_initial_state["initial_stop_reason"]'
            in after_initial_body
        ),
