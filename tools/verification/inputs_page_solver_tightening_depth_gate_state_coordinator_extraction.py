...
def build_payload() -> dict[str, Any]:
    ...
    static_checks = {
        ...
        "solver_preserves_continue_and_break": 'if tightening_depth_gate_state["should_continue"]:' in iteration_gate_after_current_eval_body
        and 'if tightening_depth_gate_state["should_break"]:' in iteration_gate_after_current_eval_body,
        "solver_rehydrates_tightening_depth_fields": 'cur_u = tightening_depth_gate_state["cur_u"]' in iteration_gate_after_current_eval_body
        and 'max_tightening_steps = tightening_depth_gate_state["max_tightening_steps"]' in iteration_gate_after_current_eval_body
        and '"final_distance_to_band": tightening_depth_gate_state["final_distance_to_band"]' in iteration_gate_after_current_eval_body,
