...
SOURCE_FILES = (
    ...
    ROOT / "design_brain" / "design_guide_controller.py",
    ROOT / "design_brain" / "final_publication.py",
)
...
def _iter_calls(source: str, *, file_name: str) -> list[dict[str, Any]]:
...
def _build_snapshot() -> dict[str, Any]:
    ...
    for path in SOURCE_FILES:
        ...
        calls.extend(_iter_calls(text, file_name=str(path.relative_to(ROOT))))
    source = "\n".join(source_parts)
