...
def main() -> int:
        ...
        call_record.update(
            {
                ...
                "bound_cleanup_rank": getattr(extracted, "_cleanup_candidate_rank", None)
                is bridge._cleanup_candidate_rank,
    ...
    checks["bridge_runtime_binds_module_globals"] = (
        ...
        and getattr(extracted, "_cleanup_candidate_rank", None) is bridge._cleanup_candidate_rank
    ...
    checks["bridge_runtime_delegates_with_arguments"] = (
        ...
        and call_record.get("bound_cleanup_rank") is True
