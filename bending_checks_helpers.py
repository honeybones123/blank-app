...
from state_and_helpers import get_param  # compatibility hook for legacy parity probes
...
def compute_bending_capacity_from_state(st_state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    # Candidate evaluation must be a pure projection of ``st_state``.  Reading
    # the live session here made a folded no-links candidate retain the
    # pre-Apply link diameter, changing effective depth and bending utility.
