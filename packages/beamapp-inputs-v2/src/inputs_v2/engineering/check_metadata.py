...
AS3600_2018_CHECKS: dict[str, dict[str, str]] = {
    ...
    "bending_phi_factor": {"standard": "AS 3600", "edition": "2018", "clause": "2.2.2", "title": "Bending strength reduction factor"},
    ...
    "kv_general_method": {"standard": "AS 3600", "edition": "2018", "clause": "8.2.4.2", "title": "General strain-based shear method"},
    "kv_simplified_method": {"standard": "AS 3600", "edition": "2018", "clause": "8.2.4.3", "title": "Simplified shear method"},
    ...
    "additional_longitudinal_shear_reinforcement": {"standard": "AS 3600", "edition": "2018", "clause": "8.2.7", "title": "Additional longitudinal force from shear or torsion"},
    ...
    "creep_coefficient": {"standard": "AS 3600", "edition": "2018", "clause": "3.1.8", "title": "Creep of concrete"},
    "shrinkage_strain": {"standard": "AS 3600", "edition": "2018", "clause": "3.1.7", "title": "Shrinkage of concrete"},
}
