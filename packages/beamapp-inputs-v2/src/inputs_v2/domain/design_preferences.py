...
class DesignPreferenceProfile:
    ...
    provisional_sls_uls_ratio: float = 0.60
    ...
    def __post_init__(self) -> None:
        ...
        if not 0.0 < self.provisional_sls_uls_ratio <= 1.0:
            raise ValueError("provisional_sls_uls_ratio must be greater than zero and at most one")
