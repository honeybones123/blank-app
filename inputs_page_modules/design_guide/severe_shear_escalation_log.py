...
def _log_severe_shear_escalation(
    *,
    ...
    agent_debug_log(
        ...
        {
            "source": source,
            "optimisation_goal": design_optimisation_goal(seed_candidate.get("state") or {}),
            "geometry_lock": geometry_lock_enabled(seed_candidate.get("state") or {}),
            "primary_action": "shear",
            "secondary_actions_with_reserve": secondary_action_reserves(seed_candidate),
