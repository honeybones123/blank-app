...
class ActionableTargetBandWinnerRuntime:
    ...
    design_optimisation_goal_label: Callable[..., Any]
    ...
    should_override_target_band_done_state: Callable[..., Any]
    updates_match_state: Callable[..., Any]
    evaluate_candidate_full: Callable[..., Any]


def _bind_actionable_target_band_runtime(
    runtime: ActionableTargetBandWinnerRuntime,
) -> None:
    globals().update(
        {
            "EFFICIENCY_TARGET_UTIL_MAX": runtime.efficiency_target_util_max,
            "EFFICIENCY_TARGET_UTIL_MIN": runtime.efficiency_target_util_min,
            "TARGET_BAND_EPS": runtime.target_band_eps,
            "_candidate_is_materially_actionable": runtime.candidate_is_materially_actionable,
            "_compute_bottom_reo_recommendation": runtime.compute_bottom_reo_recommendation,
            "_design_mode_config": runtime.design_mode_config,
            "_design_optimisation_goal": runtime.design_optimisation_goal,
            "_design_optimisation_goal_label": runtime.design_optimisation_goal_label,
            "_guidance_change_lines_for_updates": runtime.guidance_change_lines_for_updates,
            ...
            "_recommendation_search_allowed": runtime.recommendation_search_allowed,
            "_reinforcement_options_remain": runtime.reinforcement_options_remain,
            "_should_override_target_band_done_state": runtime.should_override_target_band_done_state,
...
def _get_actionable_target_band_winner(
    ...
    *,
    ...
    runtime: ActionableTargetBandWinnerRuntime | None = None,
) -> dict | None:
    if runtime is not None:
        _bind_actionable_target_band_runtime(runtime)
