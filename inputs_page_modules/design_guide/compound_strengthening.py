...
class CompoundGuidanceRuntime:
    ...
    compound_efficiency_incoherent: Callable[..., Any]
    compound_guidance_title_reasoning_why: Callable[..., Any]
    compound_strengthening_viable: Callable[..., Any]
    ...
    efficiency_distance_to_target_band: Callable[..., Any]
    ...
    try_shear_no_demand_cleanup_recommendation: Callable[..., Any]
    updates_match_state: Callable[..., Any]
    evaluate_candidate_full: Callable[..., Any]


def _bind_compound_guidance_runtime(
    runtime: CompoundGuidanceRuntime,
) -> None:
    globals().update(
        {
            ...
            "_build_design_actions_context": (
                runtime.build_design_actions_context
            ),
            "_candidate_is_growth_move": runtime.candidate_is_growth_move,
            "_collect_design_overview": runtime.collect_design_overview,
            "_compound_efficiency_incoherent": (
                runtime.compound_efficiency_incoherent
            ),
            "_compound_guidance_title_reasoning_why": (
                runtime.compound_guidance_title_reasoning_why
            ),
            "_compound_strengthening_viable": (
                runtime.compound_strengthening_viable
            ),
            "_compound_subfamilies_from_updates": (
                runtime.compound_subfamilies_from_updates
            ),
            "_compute_bottom_reo_recommendation": (
                runtime.compute_bottom_reo_recommendation
            ),
            "_compute_geometry_recommendation": (
                runtime.compute_geometry_recommendation
            ),
            "_design_mode_config": runtime.design_mode_config,
            "_design_optimisation_goal": runtime.design_optimisation_goal,
            "_efficiency_distance_to_target_band": (
                runtime.efficiency_distance_to_target_band
            ),
            ...
            "_log_efficiency_growth_rejection": (
                runtime.log_efficiency_growth_rejection
            ),
            "_recommendation_search_allowed": (
            ...
            "_try_shear_no_demand_cleanup_recommendation": (
                runtime.try_shear_no_demand_cleanup_recommendation
            ),
...
def _try_compound_strengthening_guidance_item(
    ...
    *,
    ...
    runtime: CompoundGuidanceRuntime | None = None,
) -> dict | None:
    if runtime is not None:
        _bind_compound_guidance_runtime(runtime)
