...
class EfficiencyExecutorPromotionRuntime:
    target_util_max: float
    target_util_min: float
    preview_contract_for_updates: Callable[..., tuple]
    evaluate_auto_design_candidate: Callable[..., dict | None]
    guidance_change_lines_for_updates: Callable[..., list[str]]
    guidance_executor_actionability_contract: Callable[..., tuple]
    guidance_item_is_resolved_one_click: Callable[[dict | None], bool]
    guidance_state_snapshot: Callable[[dict], dict]
    post_click_accepted_green_audit: Callable[..., dict]
    promote_guidance_item_to_resolved_candidate: Callable[..., dict | None]
    resolve_recommendation_updates: Callable[..., dict]
...
def _try_promote_efficiency_item_to_executor_backed_candidate(
    ...
    *,
    ...
    runtime: EfficiencyExecutorPromotionRuntime | None = None,
) -> tuple[dict | None, dict]:
    if runtime is None:
        namespace = globals()
        runtime = EfficiencyExecutorPromotionRuntime(
            target_util_max=namespace["EFFICIENCY_TARGET_UTIL_MAX"],
            target_util_min=namespace["EFFICIENCY_TARGET_UTIL_MIN"],
            preview_contract_for_updates=namespace[
                "_design_guide_preview_contract_for_updates"
            ],
            evaluate_auto_design_candidate=namespace[
                "_evaluate_auto_design_candidate"
            ],
            guidance_change_lines_for_updates=namespace[
                "_guidance_change_lines_for_updates"
            ],
            guidance_executor_actionability_contract=namespace[
                "_guidance_executor_actionability_contract"
            ],
            guidance_item_is_resolved_one_click=namespace[
                "_guidance_item_is_resolved_one_click"
            ],
            guidance_state_snapshot=namespace["_guidance_state_snapshot"],
            post_click_accepted_green_audit=namespace[
                "_post_click_accepted_green_audit"
            ],
            promote_guidance_item_to_resolved_candidate=namespace[
                "_promote_guidance_item_to_resolved_candidate"
            ],
            resolve_recommendation_updates=namespace[
                "_resolve_recommendation_updates"
            ],
        )
    EFFICIENCY_TARGET_UTIL_MAX = runtime.target_util_max
    EFFICIENCY_TARGET_UTIL_MIN = runtime.target_util_min
    _design_guide_preview_contract_for_updates = (
        runtime.preview_contract_for_updates
    )
