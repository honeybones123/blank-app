...
def _selector_aliases(runtime: BottomRecommendationSelectorRuntime) -> dict[str, Any]:
    return {
        "GUIDANCE_SHALLOW_GEOMETRY_SCORE_TIE_EPS": runtime.shallow_geometry_score_tie_eps,
        ...
        "_geometry_trial_axis_for_bottom_rec": runtime.geometry_trial_axis,
        "_is_strictly_rejectable_band_winner": runtime.strictly_rejectable_band_winner,
        "_legacy_bottom_local_rejection_reason": runtime.legacy_local_rejection_reason,
        "_log_design_reco_candidate_rank": runtime.log_candidate_rank,
        "_merge_design_guide_rank_trace": runtime.merge_rank_trace,
        "_score_auto_design_candidate": runtime.score_candidate,
        "_select_best_auto_design_candidate": runtime.select_best_candidate,
...
def _collapse_bottom_geometry_width_depth_trials(
    ...
    *,
    ...
    runtime: BottomRecommendationSelectorRuntime,
) -> list[dict]:
    aliases = _selector_aliases(runtime)
    GUIDANCE_SHALLOW_GEOMETRY_SCORE_TIE_EPS = aliases["GUIDANCE_SHALLOW_GEOMETRY_SCORE_TIE_EPS"]
    _geometry_trial_axis_for_bottom_rec = aliases["_geometry_trial_axis_for_bottom_rec"]
    _merge_design_guide_rank_trace = aliases["_merge_design_guide_rank_trace"]
    _score_auto_design_candidate = aliases["_score_auto_design_candidate"]
    _select_best_auto_design_candidate = aliases["_select_best_auto_design_candidate"]
...
def _pick_best_bottom_recommendation_by_selector(
    ...
    *,
    ...
    _is_strictly_rejectable_band_winner = aliases["_is_strictly_rejectable_band_winner"]
    _legacy_bottom_local_rejection_reason = aliases["_legacy_bottom_local_rejection_reason"]
    _log_design_reco_candidate_rank = aliases["_log_design_reco_candidate_rank"]
    _merge_design_guide_rank_trace = aliases["_merge_design_guide_rank_trace"]
    _select_best_auto_design_candidate = aliases["_select_best_auto_design_candidate"]
    _updates_match_state = aliases["_updates_match_state"]
