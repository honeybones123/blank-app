...
class ResolvedCandidateGuidanceRuntime:
    candidate_failure_coverage_summary: Callable[..., Any]
    guidance_before_after_text: Callable[..., Any]
    guidance_change_lines_for_updates: Callable[..., Any]
    guidance_compact_change_text: Callable[..., Any]
    guidance_compact_why_text: Callable[..., Any]
    guidance_default_alternatives_text: Callable[..., Any]
    guidance_expected_util_text: Callable[..., Any]
    guidance_item: Callable[..., Any]
    resolve_canonical_guidance_title_from_candidate: Callable[..., Any]
...
def _ensure_guidance_item_resolved_candidate_payload(
    ...
    *,
    ...
    if not resolved_updates:
        resolver = resolve_updates or _resolve_recommendation_updates
        resolved_updates = resolver(item, state=state)
    if not resolved_updates:
...
def _promote_guidance_item_to_resolved_candidate(
    ...
    *,
    state: dict,
    runtime: ResolvedCandidateGuidanceRuntime | None = None,
) -> dict | None:
    if runtime is not None:
        _candidate_failure_coverage_summary = (
            runtime.candidate_failure_coverage_summary
        )
        _guidance_change_lines_for_updates = (
        ...
        namespace = globals()
        _candidate_failure_coverage_summary = namespace[
            "_candidate_failure_coverage_summary"
        ]
...
def _guidance_item_from_resolved_candidate(
    ...
    *,
    ...
    if runtime is not None:
        ...
        _guidance_before_after_text = runtime.guidance_before_after_text
        _guidance_change_lines_for_updates = (
            runtime.guidance_change_lines_for_updates
        )
        _guidance_compact_change_text = (
            runtime.guidance_compact_change_text
        )
        _guidance_compact_why_text = runtime.guidance_compact_why_text
        _guidance_default_alternatives_text = (
            runtime.guidance_default_alternatives_text
        )
        _guidance_expected_util_text = runtime.guidance_expected_util_text
        _guidance_item = runtime.guidance_item
        _resolve_canonical_guidance_title_from_candidate = (
            runtime.resolve_canonical_guidance_title_from_candidate
        )
    else:
        namespace = globals()
        _candidate_failure_coverage_summary = namespace[
        ...
        _guidance_before_after_text = namespace[
            "_guidance_before_after_text"
        ]
        _guidance_change_lines_for_updates = namespace[
            "_guidance_change_lines_for_updates"
        ]
        _guidance_compact_change_text = namespace[
            "_guidance_compact_change_text"
        ]
        _guidance_compact_why_text = namespace[
            "_guidance_compact_why_text"
        ]
        _guidance_default_alternatives_text = namespace[
            "_guidance_default_alternatives_text"
        ]
        _guidance_expected_util_text = namespace[
            "_guidance_expected_util_text"
        ]
        _guidance_item = namespace["_guidance_item"]
        _resolve_canonical_guidance_title_from_candidate = namespace[
            "_resolve_canonical_guidance_title_from_candidate"
        ]
...
__all__ = [
    "ResolvedCandidateGuidanceRuntime",
    "bind_resolved_candidate_guidance_item_dependencies",
