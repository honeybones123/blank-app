...
def _design_guide_preview_contract_for_updates(
    ...
    if not current_fail_statuses:
        ...
        preview_pass = bool(improves_util or reduces_fail_count or not fail_statuses)
        if not preview_pass:
