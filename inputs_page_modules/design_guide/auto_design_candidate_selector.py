...
def _select_best_auto_design_candidate(
    candidates: list[dict],
    mode_config: dict,
    seed_candidate: dict,
    *,
    runtime: AutoDesignCandidateSelectorRuntime,
) -> dict | None:
    _ACTIVE_GUIDANCE_RANK_TRACE = runtime.active_rank_trace
    _annotate_candidate_target_band_metrics = runtime.annotate_candidate_target_band_metrics
    _band_reacher_delta_metrics = runtime.band_reacher_delta_metrics
    ...
    _int_from_state = runtime.int_from_state
    _merge_design_guide_rank_trace = runtime.merge_rank_trace
    _score_auto_design_candidate = runtime.score_auto_design_candidate
    _score_band_reaching_candidate_for_goal = runtime.score_band_reaching_candidate_for_goal
    _shallower_beam_selection_key = runtime.shallower_beam_selection_key
    is_valid_reo_layout = runtime.is_valid_reo_layout
    if not candidates:
        return None
