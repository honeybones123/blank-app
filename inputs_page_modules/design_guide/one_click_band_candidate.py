...
class OneClickBandCandidateRuntime:
    ...
    one_click_candidate_payload_signature: Callable[..., Any]
    select_best_auto_design_candidate: Callable[..., Any]
    updates_match_state: Callable[..., Any]
    evaluate_candidate_full: Callable[..., Any]


def _bind_one_click_band_runtime(
    runtime: OneClickBandCandidateRuntime,
) -> None:
    globals().update(
        {
            "TARGET_BAND_EPS": runtime.target_band_eps,
            "_candidate_is_materially_actionable": (
                runtime.candidate_is_materially_actionable
            ),
            "_compute_bottom_reo_recommendation": (
            ...
            "_guidance_item_from_resolved_candidate": (
                runtime.guidance_item_from_resolved_candidate
            ),
            "_guidance_state_snapshot": runtime.guidance_state_snapshot,
            "_is_in_target_zone_with_eps": (
                runtime.is_in_target_zone_with_eps
            ),
            "_one_click_candidate_payload_signature": (
                runtime.one_click_candidate_payload_signature
            ),
            "_select_best_auto_design_candidate": (
                runtime.select_best_auto_design_candidate
            ),
...
def _get_one_click_band_reaching_candidate(
    ...
    *,
    ...
    runtime: OneClickBandCandidateRuntime | None = None,
) -> dict | None:
    if runtime is not None:
        _bind_one_click_band_runtime(runtime)
