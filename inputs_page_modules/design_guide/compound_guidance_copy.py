...
class CompoundGuidanceCopyRuntime:
...
def _bind_compound_guidance_copy_runtime(
    runtime: CompoundGuidanceCopyRuntime,
) -> None:
    globals().update(
        {
...
def _compound_guidance_title_reasoning_why(
    ...
    *,
    strengthening: bool,
    runtime: CompoundGuidanceCopyRuntime | None = None,
) -> tuple[str, str, str]:
    """Returns (title_main, reasoning_with_why_prefix, guidance_why_plain)."""
    if runtime is not None:
        _bind_compound_guidance_copy_runtime(runtime)
