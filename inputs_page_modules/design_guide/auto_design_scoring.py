...
_AUTO_DESIGN_SCORING_DEPENDENCIES: tuple[str, ...] = (
    "_agent_debug_log",
    "_candidate_bending_demand_util",
    "_candidate_ductility_governs",
    "_candidate_ductility_reason",
    "_candidate_ductility_util",
    "_candidate_in_target_band",
    "_candidate_is_practical",
    "_candidate_objective_util",
    "_candidate_util_distance",
    "_candidate_violation_score",
    "_ductility_fix_tier",
    "_ductility_tier_label",
    "_mode_target_midpoint",
    "_failed_check_labels",
    "_reject_heavier_steel_lower_demand_util",
...
def bind_auto_design_scoring_dependencies(namespace: dict[str, Any]) -> None:
    globals().update(
        {
            name: namespace[name]
            for name in _AUTO_DESIGN_SCORING_DEPENDENCIES
...
__all__ = [
    "bind_auto_design_scoring_dependencies",
