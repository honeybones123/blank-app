...
class AcceptedGreenAuditRuntime:
    final_accepted_min_family_util: float
    accepted_green_cleanup_evidence_by_family: Callable[..., Any]
    accepted_green_exact_blocker_is_valid: Callable[..., Any]
    accepted_green_exact_blockers_by_family: Callable[..., Any]
    bending_low_util_floor_exact_blocker: Callable[..., Any]
    final_accepted_meaningful_family_utils: Callable[..., Any]
    governing_family_for_local_cleanup: Callable[..., Any]
    shear_low_util_active_links_exact_blocker: Callable[..., Any]
    shear_overprovision_floor_exact_blocker: Callable[..., Any]
...
def _post_click_accepted_green_audit(
    ...
    *,
    ...
    runtime: AcceptedGreenAuditRuntime | None = None,
) -> dict:
    if runtime is not None:
        final_accepted_min_family_util = (
            runtime.final_accepted_min_family_util
        )
        _accepted_green_cleanup_evidence_by_family = (
            runtime.accepted_green_cleanup_evidence_by_family
        )
        _accepted_green_exact_blocker_is_valid = (
            runtime.accepted_green_exact_blocker_is_valid
        )
        _accepted_green_exact_blockers_by_family = (
            runtime.accepted_green_exact_blockers_by_family
        )
        _bending_low_util_floor_exact_blocker = (
            runtime.bending_low_util_floor_exact_blocker
        )
        _final_accepted_meaningful_family_utils = (
            runtime.final_accepted_meaningful_family_utils
        )
        _governing_family_for_local_cleanup = (
            runtime.governing_family_for_local_cleanup
        )
        _shear_low_util_active_links_exact_blocker = (
            runtime.shear_low_util_active_links_exact_blocker
        )
        _shear_overprovision_floor_exact_blocker = (
            runtime.shear_overprovision_floor_exact_blocker
        )
    else:
        namespace = globals()
        final_accepted_min_family_util = namespace[
            "FINAL_ACCEPTED_MIN_FAMILY_UTIL"
        ]
        _accepted_green_cleanup_evidence_by_family = namespace[
            "_accepted_green_cleanup_evidence_by_family"
        ]
        _accepted_green_exact_blocker_is_valid = namespace[
            "_accepted_green_exact_blocker_is_valid"
        ]
        _accepted_green_exact_blockers_by_family = namespace[
            "_accepted_green_exact_blockers_by_family"
        ]
        _bending_low_util_floor_exact_blocker = namespace[
            "_bending_low_util_floor_exact_blocker"
        ]
        _final_accepted_meaningful_family_utils = namespace[
            "_final_accepted_meaningful_family_utils"
        ]
        _governing_family_for_local_cleanup = namespace[
            "_governing_family_for_local_cleanup"
        ]
        _shear_low_util_active_links_exact_blocker = namespace[
            "_shear_low_util_active_links_exact_blocker"
        ]
        _shear_overprovision_floor_exact_blocker = namespace[
            "_shear_overprovision_floor_exact_blocker"
        ]
...
def _one_click_post_commit_audit(intended: dict) -> dict:
    ...
    try:
        ...
        if isinstance(shared_packed_eval, dict):
            ...
            # The committed shared snapshot is the transaction authority.  The
            # summary surface may still hold pre-rerun defaults or publication
            # state, so it is diagnostic here rather than a commit veto.
            post_worst = post_eval_shared_packed_worst
            post_statuses = dict(post_eval_shared_packed_statuses)
