...
def _append_geometry_bottom_compound_candidates(
    *,
    ...
    runtime: RecommendationCompoundRuntime,
) -> None:
    """Width/depth + bottom reo compounds using layouts regenerated on geometry-adjusted states."""
    _annotate_bottom_reo_candidate_deltas = runtime.annotate_bottom_deltas
    _arrangement_fits_state = runtime.arrangement_fits_state
    _bottom_arrangement_to_shared_updates = runtime.bottom_arrangement_updates
    _bottom_recommendation_compound_effective_signature = runtime.compound_effective_signature
    _bottom_recommendation_compound_title = runtime.compound_title
    _candidate_state_to_shared_updates = runtime.candidate_state_updates
    _compound_merged_signature_preview = runtime.compound_signature_preview
    _evaluate_candidate_fast = runtime.evaluate_candidate_fast
    _generate_local_bottom_arrangements = runtime.generate_bottom_arrangements
    _geometry_trial_axis_for_bottom_rec = runtime.geometry_trial_axis
    _practical_bottom_reo_label = runtime.practical_bottom_label
    _select_top_geometry_seeds_for_compound = runtime.select_geometry_seeds
