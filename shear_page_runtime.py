...
from shear_core import build_shear_zone_layout_strip_figure
# Shared helpers (same contract as Inputs/Bending)
from widgets_helpers import apply_result_page_css, calcbox, clickable_calcbox, render_step, apply_step_summary_expander_css, info_i_button, page_divider, render_page_explainer_expander, render_section_title, _register_rendered_key, _wrap_user_edit, render_plotly_diagram, render_image_diagram
