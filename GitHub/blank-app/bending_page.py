...
def render_bending():
    ...
    # Remove green background from inline math/LaTeX (global override)
    st.markdown(
        """
<style>
/* Remove green background from math/LaTeX elements in markdown */
div[data-testid="stMarkdownContainer"] p .katex,
div[data-testid="stMarkdownContainer"] p .katex-html,
div[data-testid="stMarkdownContainer"] p code,
div[data-testid="stMarkdownContainer"] p span.katex,
div[data-testid="stMarkdownContainer"] p span.katex-display,
div[data-testid="stMarkdownContainer"] code,
.stMarkdown p .katex,
.stMarkdown p .katex-html,
.stMarkdown p code,
.stMarkdown p span.katex,
.stMarkdown p span.katex-display,
.stMarkdown code {
