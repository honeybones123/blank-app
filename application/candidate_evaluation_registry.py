"""Run-scoped candidate evaluation registry owned by the application layer.

The registry is intentionally independent of Streamlit and Design Brain.  It
deduplicates evaluations for one run and exposes only scalar cache evidence.
"""
