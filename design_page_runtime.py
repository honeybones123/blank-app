...
_support_type_from_load_case = _design_inputs_section._support_type_from_load_case
_defl_support_type_from_selection = _design_inputs_section._defl_support_type_from_selection
_sync_design_shared_value = _design_inputs_section._sync_design_shared_value
_format_solver_vector = _design_inputs_section._format_solver_vector
_format_solver_matrix = _design_inputs_section._format_solver_matrix
_format_support_restraints = _design_inputs_section._format_support_restraints
_clean_sfd_deriv_lines = _design_inputs_section._clean_sfd_deriv_lines
_get_beam_analysis_case_label = _design_inputs_section._get_beam_analysis_case_label
_is_closed_form_sfd_case = _design_inputs_section._is_closed_form_sfd_case
_build_solver_explanation_lines = _design_inputs_section._build_solver_explanation_lines
_strip_sfd_step4_title_line = _design_inputs_section._strip_sfd_step4_title_line
_strip_leading_load_intro = _design_inputs_section._strip_leading_load_intro
...
# Preserve the former page-local solver for parity inspection, but route live
# repeated renders through the neutral bounded cache.
_compute_diagram_arrays_uncached_legacy = _compute_diagram_arrays
_compute_diagram_arrays = _compute_diagram_arrays_cached_service
...
def render_sfd_bmd_page():
    ...
    render_timing_mark("design_page.runtime.start")
...
"""
    ...
    # ---------------------------------------------------
    render_timing_mark("design_page.runtime.derivation.start")
