    ...
    *,
    ...
    with design_guide_slot.container():
        st_module.markdown(
            ...
            # During a Streamlit transaction, hide only the previous Design
            # Brain publication and CTA.  Summaries, controls and widgets keep
            # their current values while this neutral shell is visible.  This
            # browser-side gate closes the network-latency window before the
            # first server delta can arrive on a cold hosted session.
