    ...
    *,
    ...
    with design_guide_slot.container():
        st_module.markdown(
            ...
            "div[data-testid=\"stExpander\"]:has(.inputs-v2-design-guide-copy) summary{height:40px!important;min-height:40px!important;padding:0 .8rem!important;box-sizing:border-box!important;display:flex!important;align-items:center!important;font-weight:700;color:#0f172a;}"
            ...
            "div[data-testid=\"stExpander\"]:has(.inputs-v2-design-guide-copy) details:not([open]){height:40px!important;min-height:40px!important;}"
