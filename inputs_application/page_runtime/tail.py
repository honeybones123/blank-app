"""Permanent Inputs page tail runtime."""
...
def _handle_inputs_auto_design_current_coordinator() -> None:
    handle_inputs_auto_design(
        ...
        runtime=AutoDesignRoutingRuntime(
            _append_design_guide_trace, attach_recommendation_envelope, _clear_auto_design_runtime_latches,
            _reconcile_design_action_widgets_with_shared, lambda: reconcile_shear_widgets_with_shared(session_state=st.session_state, runtime=ShearWidgetReconciliationRuntime(_append_design_guide_trace, _request_shear_widget_seed_from_shared, set_shared, _shared_state_snapshot), debug_enabled=DEBUG_DESIGN_GUIDANCE_PROBE),
            _resolve_design_actions_from_state, _resolved_inputs_summary_state, run_one_click_auto_design,
            lambda label, extra=None: set_design_guide_live_breadcrumb(st.session_state, label, extra), _shared_state_snapshot,
        ),
